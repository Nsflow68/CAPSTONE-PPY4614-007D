                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        UserJourneyBanner(
                          highlight:
                              'Descubre cÃ³mo usar Inicio, Diario, Chatbot y Perfil con recomendaciones personalizadas.',
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Text(
              'Activa recordatorios, revisa emociones recientes y continÃºa tu rutina.',
            ...
            Wrap(
              ...
              children: [
                _StatChip(
                  label: highlight.scoreLabel,
                  icon: Icons.favorite_rounded,
                ),
                _StatChip(
                  label: highlight.dateLabel,
            ...
            children: [
              Expanded(
                child: FilledButton(
                  ...
                  child: Text(
                    highlight.hasEntry ? 'Registrar otra' : 'Registrar emociÃ³n',
                  ),
                ),
              ),
              const SizedBox(width: 12),
...
class _EmotionCarouselState extends ConsumerState<_EmotionCarousel> {
  ...
  Widget build(BuildContext context) {
    ...
    final totalItems = hasHighlights
        ? diaryHighlights.length
      ...
      children: [
        ...
        state.when(
          ...
          loaded: (summary) {
            ...
            if (rewards.isEmpty) {
              return _RewardError(
                message: 'AÃºn no hay recompensas configuradas.',
                onRetry: onViewAll,
              );
            }
...
class _HydrationSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return hydrationSummary.when(
      data: (entries) =>
          _HydrationContent(entries: entries, onViewDetails: onViewDetails),
...
class _HydrationContent extends StatelessWidget {
  const _HydrationContent({required this.entries, required this.onViewDetails});
  ...
  Widget build(BuildContext context) {
    ...
    final todayEntry = entries.firstWhere(
      ...
      orElse: () => HydrationDailyIntake(date: today, goalMl: 2000),
    );
    ...
    final completedDays = entries
        .where((entry) => entry.goalMl != null && entry.progress >= 1)
        .length;
        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              ...
              _HydrationMetricChip(
                ...
                label: '$completedDays/7 dÃ­as al dÃ­a',
              ),
            ],
          ),
          if (hasEntries) ...[
            ...
            const SizedBox(height: 18),
            Text(
              'AÃºn no registras ingestas esta semana. Ve al mÃ³dulo para comenzar.',
              style: theme.textTheme.bodySmall?.copyWith(
                color: AppColors.textSecondary,
              ),
            ),
          ...
          Align(
            ...
            child: TextButton.icon(
              ...
              label: const Text('Abrir registro de hidrataciÃ³n'),
              ...
              children: [
                Text(
                  isLoading
                      ...
                      : (message ??
                            'Consulta tu progreso de hidrataciÃ³n aquÃ­.'),
                  style: theme.textTheme.bodyMedium?.copyWith(
                    fontWeight: FontWeight.w600,
                    color: AppColors.textPrimary,
                  ),
                ...
                Text(
                  isLoading
                      ? 'Ajustando recomendaciones segÃºn tu actividad.'
                      : 'Valida tu conexiÃ³n y vuelve a intentar si el problema persiste.',
                  style: theme.textTheme.bodySmall?.copyWith(
                    color: AppColors.textSecondary,
                  ),
                ),
