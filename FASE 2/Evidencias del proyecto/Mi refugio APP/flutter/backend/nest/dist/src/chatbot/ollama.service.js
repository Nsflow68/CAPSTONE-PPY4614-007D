...
let OllamaService = OllamaService_1 = class OllamaService {
    ...
    async generate(params) {
        const { prompt, system = 'Actúa como un acompañante emocional empático. Responde con calidez, escucha activa y ofrece sugerencias simples para manejar emociones como ansiedad, estrés o tristeza.', temperature = 0.4, timeoutMs = 60_000, } = params;
