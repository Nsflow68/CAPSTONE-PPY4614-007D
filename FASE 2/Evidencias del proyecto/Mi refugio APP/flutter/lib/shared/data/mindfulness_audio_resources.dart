...
const mindfulnessAudioResources = <MindfulnessAudioResource>[
  MindfulnessAudioResource(
    ...
    duration: '10 min · Paula Ariza',
    assetPath: 'assets/audio/mindfulness_atencion_10min.mp3',
  ...
  MindfulnessAudioResource(
    ...
    duration: '16 min · Paula Ariza',
    assetPath: 'assets/audio/mindfulness_exploracion_16min.mp3',
  ...
  MindfulnessAudioResource(
    ...
    duration: '26 min · Paula Ariza',
    assetPath: 'assets/audio/mindfulness_compasion_26min.mp3',
